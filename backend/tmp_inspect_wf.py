...
print('compiled object type:', type(wf))
print('repr:', repr(wf))
print('dir snippet:', [a for a in dir(wf) if 'node' in a or 'edges' in a or 'graph' in a or 'nodes' in a])
try:
	g = wf.get_graph()
	print('wf.get_graph():', g)
except Exception as e:
	print('failed to get graph:', e)
